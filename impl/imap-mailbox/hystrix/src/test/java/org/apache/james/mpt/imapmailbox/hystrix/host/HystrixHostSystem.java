...
package org.apache.james.mpt.imapmailbox.hystrix.host;
...
import org.apache.james.mailbox.hystrix.quota.HystrixCurrentQuotaManager;
import org.apache.james.mailbox.hystrix.quota.HystrixMaxQuotaManager;
...
public class HystrixHostSystem extends JamesImapHostSystem {

    private StoreMailboxManager<InMemoryId> mailboxManager;
    private MockAuthenticator userManager;

    public static JamesImapHostSystem build() throws Exception {
        return new HystrixHostSystem();
    }

    private HystrixHostSystem() throws MailboxException {
        initFields();
    }
    ...
    private void initFields() throws MailboxException {
        ...
        MaxQuotaManager maxQuotaManager = new HystrixMaxQuotaManager(perUserMaxQuotaManager);

        InMemoryCurrentQuotaManager wrappedCurrentQuotaManager = new InMemoryCurrentQuotaManager(
            new CurrentQuotaCalculator(factory, quotaRootResolver),
            mailboxManager);
        StoreCurrentQuotaManager currentQuotaManager = new HystrixCurrentQuotaManager(wrappedCurrentQuotaManager);
